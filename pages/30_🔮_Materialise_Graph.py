...
with tab1:
    ...
    # DATA SOURCES AVAILABLE: BUILD CONFIG FILE---------------------------------
    else:
        # AUTOCONFIG MODE ACTIVE
        if st.session_state["autoconfig_active_flag"]:
            ...
            with col1:
                st.markdown(f"""<div class="gray-preview-message">
                    🔒 A <b>Config file</b> has been <b>automatically generated</b>.
                    <small> Click below to enable <b>✏️ manual configuration</b>.</small>
                </div>""", unsafe_allow_html=True)
                st.write("")
